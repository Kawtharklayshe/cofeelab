(function($) {
	...
	// 			otherItem.querySelector(".accordion-content").classList.remove("appear")
	// 		}
	// 	});
		  ...
		  item.querySelector(".accordion-title").addEventListener("click", function() {
			accordionItems.forEach(otherItem => {
			  if (otherItem !== item) {
				...
				otherItem.querySelector(".accordion-content").style.padding = "0";
				otherItem.querySelector(".accordion-content").style.border = "none";
				otherItem.querySelector('.sign').innerHTML = "+"
			}
		});
	...
	function debounce(func, wait = 20, immediate = true) {
	  ...
	  function checkSlide() {
		sliderImages.forEach(sliderImage => {
		  ...
		  if (isHalfShown && isNotScrolledPast && !sliderImage.classList.contains('active')) {
